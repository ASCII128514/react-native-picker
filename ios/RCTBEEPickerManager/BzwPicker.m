...
//    view.layer.cornerRadius = 25;
    ...
    UIColor* color = [UIColor colorWithRed:0.976 green:0.976 blue:0.976 alpha:1];
    ...
    UILabel *cenLabel=[[UILabel alloc]initWithFrame:CGRectMake(90, 5, SCREEN_WIDTH-180, 50)];
    ...
    self.pick = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 60, self.frame.size.width, self.frame.size.height - 60)];
